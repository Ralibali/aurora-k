...
export function DriverLayout({ children }: DriverLayoutProps) {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <header className="h-14 flex items-center justify-center border-b bg-card px-4 shrink-0">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t flex z-50">
        <NavLink
          ...
          className="flex-1 flex flex-col items-center justify-center py-3 text-muted-foreground transition-colors"
