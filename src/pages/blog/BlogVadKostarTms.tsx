...
export default function BlogVadKostarTms() {
  return (
    <BlogLayout
      ...
      readTime="5 min"
    >
      <p>Det är en av de vanligaste frågorna vi får: "Vad kostar ett TMS?" Svaret är att det beror helt på vad du jämför. Prisskillnaden mellan det dyraste och det mest prisvärda systemet kan vara 50 000 kr exkl. moms per år eller mer.</p>
      ...
      <h3>Mellansegmentet (15 000–80 000 kr/år exkl. moms)</h3>
      ...
      <h3>Moderna molnlösningar (under 10 000 kr/år exkl. moms)</h3>
      <p>Det snabbväxande segmentet. Enkla, mobilfirst-system med fast och transparent prissättning. Aurora Transport tillhör den här kategorin: 449 kr/månad exkl. moms utan startavgift.</p>
