...
export function FirstAssignmentStep({ draft, drivers, submitting, onChange, onSubmit, onSkip, onRefreshDrivers }: {
  ...
  return (
    <div className="space-y-5">
      ...
      <Button type="button" size="sm" variant="outline" onClick={onRefreshDrivers} disabled={submitting}>Uppdatera chaufförer</Button>
