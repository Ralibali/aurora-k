...
describe('driver route order', () => {
  ...
  it('does not treat a null sequence as stop zero', () => {
    const rows = [{ scheduled_start: '2026-06-26T08:00:00Z', route_sequence: null }, { scheduled_start: '2026-06-26T10:00:00Z', route_sequence: 1 }];
    expect(rows.sort(compareRouteOrder)[0].route_sequence).toBe(1);
  });
