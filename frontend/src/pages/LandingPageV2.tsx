...
export default function LandingPageV2() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f9fc] text-slate-950">
      ...
      <main>
        <section className="relative overflow-hidden border-b border-slate-200 bg-[radial-gradient(circle_at_15%_10%,rgba(18,59,136,0.14),transparent_32rem),linear-gradient(180deg,#eef5ff_0%,#f8fafc_58%,#ffffff_100%)]">
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 md:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-8 lg:py-24">
